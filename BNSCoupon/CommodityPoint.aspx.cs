...
namespace BNSCoupon
{
    public partial class CommodityPoint : System.Web.UI.Page
    {
        ...
        {
            gdCommodity.DataSource = bll.getPointData();
        ...
        protected void linkDelete_Click(object sender, EventArgs e)
        {
            ...
            if (bll.deletePointData(Convert.ToInt32(((LinkButton)sender).CommandName)))
                bindData(bll);
        }
    }
}