<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="PointLog.aspx.cs" Inherits="BNSCoupon.PointLog" %>
                        ...
                        <ItemTemplate>
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width: 15%; text-align: center;"><%# Eval("point") %></td>
