    ...
    <div class="chi_div">
        ...
        <div style="width: 100%;">
            <table width="90%">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnAddaccount" runat="server" Text="添加账号" OnClick="btnAddaccount_Click" UseSubmitBehavior="false"/>
                    </td>
                    <td align="right">
                        <asp:Button ID="btnRecycleBin" runat="server" Text="回收站" OnClick="btnRecycleBin_Click" UseSubmitBehavior="false"/>
                    </td>
                </tr>
            </table>
        </div>
