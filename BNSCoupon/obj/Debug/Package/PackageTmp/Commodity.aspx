<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="Commodity.aspx.cs" Inherits="BNSCoupon.Commodity" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    <div class="chi_div">
        <asp:GridView ID="gdCommodity" CellPadding="4" GridLines="None" runat="server" CssClass="grid_b" AutoGenerateColumns="False" Width="80%" AllowPaging="True" OnPageIndexChanging="gdCommodity_PageIndexChanging" OnRowDataBound="gdCommodity_RowDataBound" PageSize="12">
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td style="width: 13%; text-align: center;">
                                    <a href='<%# "Storehouse.aspx?action=edt&id="+ Eval("id")%>'>修改</a>
                                    <asp:LinkButton ID="linkDelete" runat="server" CommandName='<%# Eval("id") %>' OnClientClick="return confirm('确定要下架该商品吗？下架后可在商品仓库中重新上架');" OnClick="linkDelete_Click">下架</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
        ...
        <table width="80%">
            <tr>
                <td><a href="Storehouse.aspx?action=add">添加商品</a></td>
                <td align="right"><a href="Undercarriage.aspx">商品仓库</a></td>
            </tr>
        </table>
    </div>
</asp:Content>
